 ...
 */
final class Version20241217100041 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE programme (id INT AUTO_INCREMENT NOT NULL, session_id INT NOT NULL, session_module_id INT NOT NULL, nb_jours INT NOT NULL, INDEX IDX_3DDCB9FF613FECDF (session_id), INDEX IDX_3DDCB9FFEC20F09B (session_module_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, formation_id INT NOT NULL, formateur_id INT DEFAULT NULL, nom_session VARCHAR(100) NOT NULL, nb_places INT NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, INDEX IDX_D044D5D45200282E (formation_id), INDEX IDX_D044D5D4155D8F51 (formateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE session_module (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, nom_session_module VARCHAR(150) NOT NULL, INDEX IDX_634F2C71BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE stagiaire (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, adresse VARCHAR(100) NOT NULL, code_postal VARCHAR(50) NOT NULL, ville VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE programme ADD CONSTRAINT FK_3DDCB9FFEC20F09B FOREIGN KEY (session_module_id) REFERENCES session_module (id)');
        ...
        $this->addSql('ALTER TABLE session_module ADD CONSTRAINT FK_634F2C71BCF5E72D FOREIGN KEY (categorie_id) REFERENCES categorie (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE programme DROP FOREIGN KEY FK_3DDCB9FFEC20F09B');
        ...
        $this->addSql('ALTER TABLE session_module DROP FOREIGN KEY FK_634F2C71BCF5E72D');
